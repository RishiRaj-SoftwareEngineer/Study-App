        ...
        <div className="bg-[#1A1A1A] rounded-lg md:rounded-xl p-4 md:p-6 border border-[#F5F5F5]/5">
            ...
            {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                    ...
                    {/* Feedback Type */}
                    <div className={errors.feedbackType ? "error-field" : ""}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
                            {feedbackTypes.map((type) => (
                                <button
                                    ...
                                    type="button"
                                    onClick={() => {
                                        setFeedbackData({ ...feedbackData, feedbackType: type.id })
                        ...
                        {errors.feedbackType && (
                            <p className="mt-2 text-xs text-red-400">{errors.feedbackType}</p>
                        )}
                    </div>
                    {/* Overall Rating */}
