...
export default function LandingFooter() {
    const SupportLinks = [
        ...
        {
            label: 'Contact Us',
            url: 'mailto:reeshiraj01@gmail.com',
        },
        {
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="md:col-span-2">
                        ...
                        <p className="text-[#F5F5F5]/70 mb-6 text-lg">
                            Empowering students with free access to collaborative learning tools.
                            Share knowledge, grow together, succeed faster.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-[#F5F5F5]/70">
                            {SupportLinks.map((links) => (
                                <li key={links.label}>
                                    {links.url.startsWith('http') || links.url.startsWith('mailto') ? (
                                        <a
                                            href={links.url}
                ...
                <div className="border-t border-[#F5F5F5]/10 mt-12 pt-8 text-center text-[#F5F5F5]">
                    <p>
                        ...
                        <a
                            ...
                            target="_blank"
                            className=" text-[#00E5FF] hover:text-[#FF007F]"
                        >
                            Rishi Raj Pandey
                        </a>
                    </p>
                    ...
                    <div className="flex gap-4 items-center justify-center mt-2">
                        <a
                            href="https://github.com/RishiRaj-SoftwareEngineer"
                            target="_blank"
                            className="text-[#F5F5F5]/60 hover:text-[#FF007F] transition-colors"
                        >
                            <Github size={24} />
                        </a>
                        <a
                            href="https://x.com/reeshi_pandey"
                            target="_blank"
                            className="text-[#F5F5F5]/60 hover:text-[#FF007F] transition-colors"
                        >
                            <Twitter size={24} />
                        ...
                        <a
                            href="https://www.linkedin.com/in/rishi-raj-pandey-b4167225b/"
                            target="_blank"
                            className="text-[#F5F5F5]/60 hover:text-[#FF007F] transition-colors"
                        >
                            <Linkedin size={24} />
                        ...
                        <a
                            href="https://mail.google.com/mail/?view=cm&fs=1&to=reeshiraj01@gmail.com"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[#F5F5F5]/60 hover:text-[#FF007F] transition-colors"
                        >
