...
import { isTeacher, isAdmin } from '../utils/roles.js';
...
function navBar() {
    ...
    // Load the user profile once so role-based navigation is reliable
    useEffect(() => {
        if (!user) fetchUser();
    }, [user, fetchUser]);
    ...
    return (
        <div className="flex h-screen bg-[#0D0D0D] text-[#F5F5F5] relative">
            ...
            >
                ...
                <nav className="flex-1 mt-3 border-t border-[#F5F5F5]/10">
                    <ul className="space-y-1">
                        ...
                        <li>
                            <NavLink
                                to={'/Dashboard'}
                                className={({ isActive }) =>
                                    `w-full flex items-center gap-3 py-2 px-3 rounded-lg transition-all duration-200 ${isActive
                        ...
                        {isTeacher(user) ? (
                            <>
                                <li className="mt-2 px-3 text-xs uppercase tracking-wider text-[#F5F5F5]/40">
                                    Teaching
                                </li>
                                <li>
                                    <NavLink
