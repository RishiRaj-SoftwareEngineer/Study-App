...
export default function Quiz() {
    ...
    const canCreateQuiz = isTeacher(user) || isAdmin(user);
...
const filteredQuiz = QuizzesList
    ...
    return (
        <div className="space-y-4 md:space-y-6">
            <Header route="Quiz" onAddClick={canCreateQuiz ? handleAddQuizClick : undefined} title={"Quizzes"} description={"Test your knowledge with interactive quizzes"} />
